...
class AppRoutes {
  ...
  static Map<String, WidgetBuilder> get routes {
    return {
      ...
      liveCameraView: (context) => const BusinessDashboard(initialIndex: 1),
      staffManagement: (context) => const BusinessDashboard(initialIndex: 3),
      ...
      orderManagementHub: (context) => const BusinessDashboard(initialIndex: 5),
      securityAlertsDashboard: (context) => const SecurityAlertsDashboard(),
      paymentProcessingCenter: (context) =>
